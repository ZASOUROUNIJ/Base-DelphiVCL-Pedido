...
type
  TModelConnectionsFiredacQuery = class(TInterfacedObject, iModelConnectionQuery)
    ...
    public
      ...
      function ExecSQl : iModelConnectionQuery; overload;
      //function ExecSQL(const ASQL : string; const Aparams : array of Variant;const Atypes: array of TFieldType) : integer; overload;
